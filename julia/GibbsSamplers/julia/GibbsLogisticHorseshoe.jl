...
function gibbs_horselogit(
    ...
    (N, p, _beta, mu, kappa, X, Xint, Xt, xtx, om, Om, _A, _A_ms, _iLams, _muvec, munc, muint, _beta_store, _py_store) =
    ...
    res = DataFrame(
        hcat([chain for i = 1:iter], [i for i = 1:iter], _py_store, _beta_store, _lamsq_store, _tausq_store),
        vcat(
            :chain,
            :iter,
            :m1,
